...
const _transportCopy = <CarePointLocale, Map<String, String>>{
  CarePointLocale.en: {
    ...
    'wheelchair': 'Wheelchair', 'stretcher': 'Stretcher', 'companions': 'Companions', 'equipment': 'Requested equipment', 'none': 'None',
    'oxygen': 'Oxygen', 'monitoring': 'Monitoring', 'ventilation': 'Ventilation',
    'request': 'Request transport', 'cancel': 'Cancel request', 'status': 'Status', 'eta': 'ETA',
  ...
  CarePointLocale.ar: {
    ...
    'wheelchair': 'كرسي متحرك', 'stretcher': 'نقالة', 'companions': 'المرافقون', 'equipment': 'المعدات المطلوبة', 'none': 'لا شيء',
    'oxygen': 'أكسجين', 'monitoring': 'مراقبة', 'ventilation': 'تهوية',
    'request': 'طلب النقل', 'cancel': 'إلغاء الطلب', 'status': 'الحالة', 'eta': 'الوقت المتوقع',
  ...
  CarePointLocale.fr: {
    ...
    'wheelchair': 'Fauteuil roulant', 'stretcher': 'Brancard', 'companions': 'Accompagnants', 'equipment': 'Équipement demandé', 'none': 'Aucun',
    'oxygen': 'Oxygène', 'monitoring': 'Monitorage', 'ventilation': 'Ventilation',
    'request': 'Demander le transport', 'cancel': 'Annuler la demande', 'status': 'Statut', 'eta': 'Arrivée estimée',
  ...
  CarePointLocale.es: {
    ...
    'wheelchair': 'Silla de ruedas', 'stretcher': 'Camilla', 'companions': 'Acompañantes', 'equipment': 'Equipamiento solicitado', 'none': 'Ninguno',
    'oxygen': 'Oxígeno', 'monitoring': 'Monitorización', 'ventilation': 'Ventilación',
    'request': 'Solicitar transporte', 'cancel': 'Cancelar solicitud', 'status': 'Estado', 'eta': 'Tiempo estimado',
