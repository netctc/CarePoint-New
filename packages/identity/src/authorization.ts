...
const grants: Record<IdentityRole, readonly Permission[]> = {
  ...
  DOCTOR: ["PROVIDER_SELF_ONBOARD", "PROVIDER_MANAGE_SERVICES", "PROVIDER_MANAGE_AVAILABILITY", "SELF_SESSION_MANAGE"],
  OTHER_PROVIDER: ["PROVIDER_SELF_ONBOARD", "PROVIDER_MANAGE_SERVICES", "PROVIDER_MANAGE_AVAILABILITY", "SELF_SESSION_MANAGE"],
};
