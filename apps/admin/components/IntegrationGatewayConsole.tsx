...
type Kind = "fhir" | "labs";
type Copy = {
  refresh:string; loading:string; failed:string; newConfig:string; code:string; name:string; environment:string;
  baseUrl:string; credential:string; scopes:string; create:string; test:string; activate:string; mapping:string;
  resource:string; direction:string; mappingJson:string; publish:string; status:string; lastTest:string; mappings:string;
  sourceSystem:string; healthPath:string; publicKey:string; externalCode:string; codeSystem:string; internalCode:string;
  display:string; unit:string; events:string; order:string; error:string; retry:string; release:string; sandbox:string;
};
