...
const copy: Record<Locale, Copy> = {
  ...
  es:{refresh:"Actualizar",loading:"Cargando…",failed:"La solicitud falló.",empty:"Sin registros.",score:"Puntuación",reasons:"Evidencia",review:"Revisar fusión",patientA:"Paciente A",patientB:"Paciente B",connector:"Conector",health:"Salud",configured:"Configurado",credentials:"Referencias de credenciales",lastSync:"Última sincronización",lastError:"Último error",createExport:"Crear exportación firmada",from:"Desde",to:"Hasta",action:"Acción",objectType:"Tipo de objeto",result:"Resultado",status:"Estado",expires:"Expira",digest:"SHA-256",download:"Descargar",generated:"Generado",questionnaires:"Questionnaires vencidos",plans:"Planes sin revisión",alerts:"Alertas RPM abiertas",results:"Resultados de laboratorio pendientes",orphanTasks:"Tareas huérfanas",methodology:"Metodología reproducible",yes:"Sí",no:"No",limit:"Límite"},
};
