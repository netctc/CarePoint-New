...
const WORKFLOW = ["CATEGORY_FORMS", "HOME_VISIT_ARRIVAL", "SERVICE_COMPLETION_CHECKLIST", "MEDIA_CAPTURE", "MED_ADMIN", "WOUND_CARE", "PROCEDURE_CHECKLIST", "TRANSPORT_EQUIPMENT_CHECKLIST", "TRANSPORT_REJECT", "TRANSPORT_ACCEPT", "SUPPLY_TRACKING"] as const;
