...
CREATE UNIQUE INDEX "PatientClinicalExportJob_accountId_idempotencyKey_key"
  ON "PatientClinicalExportJob"("accountId", "idempotencyKey");
...
CREATE INDEX "PatientClinicalExportJob_patientId_status_createdAt_idx"
  ON "PatientClinicalExportJob"("patientId", "status", "createdAt");
CREATE INDEX "PatientClinicalExportJob_status_availableAt_idx"
  ON "PatientClinicalExportJob"("status", "availableAt");
CREATE INDEX "PatientClinicalExportJob_leaseUntil_idx"
  ON "PatientClinicalExportJob"("leaseUntil");
CREATE INDEX "PatientClinicalExportJob_expiresAt_status_idx"
  ON "PatientClinicalExportJob"("expiresAt", "status");
CREATE UNIQUE INDEX "PatientClinicalExportDownloadGrant_tokenHash_key"
  ON "PatientClinicalExportDownloadGrant"("tokenHash");
CREATE INDEX "PatientClinicalExportDownloadGrant_jobId_accountId_expiresAt_idx"
  ON "PatientClinicalExportDownloadGrant"("jobId", "accountId", "expiresAt");
CREATE INDEX "PatientClinicalExportDownloadGrant_expiresAt_consumedAt_idx"
...
ALTER TABLE "PatientClinicalExportDownloadGrant"
  ADD CONSTRAINT "PatientClinicalExportDownloadGrant_jobId_fkey"
  FOREIGN KEY ("jobId") REFERENCES "PatientClinicalExportJob"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
ALTER TABLE "PatientClinicalExportDownloadGrant"
