...
export class DoctorAllergyReconciliationController {
  ...
  @Post(":patientId/clinical-profile/allergies")
  @Header("Cache-Control", "no-store")
  create(
    @CurrentPrincipal() principal: AuthPrincipal,
    @Param("patientId") patientId: string,
  ...
  @RequirePermissions("CLINICAL_PROFILE_WRITE")
  @Patch(":patientId/clinical-profile/allergies/:entryId")
  @Header("Cache-Control", "no-store")
  update(
    @CurrentPrincipal() principal: AuthPrincipal,
    @Param("patientId") patientId: string,
  ...
  @RequirePermissions("CLINICAL_PROFILE_WRITE")
  @Post(":patientId/clinical-profile/allergies/:entryId/verify")
  @Header("Cache-Control", "no-store")
  verify(
    @CurrentPrincipal() principal: AuthPrincipal,
    @Param("patientId") patientId: string,
