...
import { ProviderCapabilityWorkspaceModule } from "./modules/provider-capability-workspace/provider-capability-workspace.module";
...
@Module({
  imports: [
    ...
    ProviderCapabilityWorkspaceModule,
