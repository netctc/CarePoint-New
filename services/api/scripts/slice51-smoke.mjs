...
async function main() {
  ...
  const doctorAToken = await login('doctor-clinical-a@carepoint.test', doctorPassword);
  const doctorBToken = await login('doctor-clinical-b@carepoint.test', doctorPassword);
